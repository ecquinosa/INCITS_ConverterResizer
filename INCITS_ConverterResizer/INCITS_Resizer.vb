...
Public Class INCITS_Resizer
    ...
    Public ReadOnly ISO_19794_2_EXT As String = ".iso-fmr"
    Public ReadOnly Morpho_CFV_EXT As String = ".cfv"

    Public ReadOnly ANSI_378 As String = "ANSI_378"
    Public ReadOnly ISO_19794_2 As String = "ISO_19794_2"
    Public ReadOnly ISO_19794_2_CF_CS As String = "ISO_19794_2_CF_CS"
    Public ReadOnly Morpho_CFV As String = "Morpho_CFV"
    Private _FileType As String = ""
    'Private _MK_CONVERT_PATH As String = "Bin\mk_convert.exe"
    Private _MK_CONVERT_PATH As String = "D:\Software\Sagem\morphokit-5.3\vs80\Bin\mk_convert.exe" '"D:\EDEL\ACC\Software\Sagem\Sagem 5.3\MorphoKit_5_3\morphokit-5.3\vs80\Bin\mk_convert.exe"
    Private _ErrorMessage As String = ""
    Private _OutputFile As String = ""

    Public ReadOnly Morpho_CFV_FileFormat As Short = 0
    Public ReadOnly ANSI_378_FileFormat As Short = 10
    Public ReadOnly ISO_19794_2_FileFormat As Short = 20
    ...
    Public Function ResizeIncits2(ByVal inputFile As String) As Boolean
        If Convert(inputFile, ISO_19794_2_FileFormat, ANSI_378_FileFormat, ANSI_378_EXT) Then
            Dim _firstOutputFile As String = _OutputFile
            _OutputFile = inputFile
    ...
    Public Function ResizeIncits3(ByVal inputFile As String) As Boolean
        If Convert(inputFile, ANSI_378_FileFormat, ISO_19794_2_FileFormat, ISO_19794_2_EXT) Then
            Dim _firstOutputFile As String = _OutputFile
            _OutputFile = inputFile
